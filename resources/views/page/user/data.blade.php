...
<body>
                    ...
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-end">
                                <a href="{{ url('/user/tambah') }}" class="btn btn-primary" id="btnTambah">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <a href="{{ url('/user/detail/'.$user->uuid) }}"
                                                    class="btn btn-primary m-1 btn-detail">
                                                    <img src="{{ asset($tPath.'assets2/icon/detail.png') }}" alt="">
                                                    Detail
                                                </a>
                                                <button type="button" onclick="showModalDelete('{{ $user->uuid }}')"
    ...
    <script src="{{ asset($tPath.'assets2/js/page/user/data.js') }}"></script>
</body>
